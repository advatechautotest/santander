...
public class IncydentZamkniecie extends TestBase {
    @Test

    public void testIncydentZamkniecie() throws Exception{
        ...
        app.getAkcja().DodajNotatke();
        app.getIncydent().NotatkaRodzaj();
        app.getIncydent().NotatkarodzajPrywatna();
        app.screenShot();
        app.getIncydent().NotatkaTytul();
        app.screenShot();
        app.saveandcloseButton();
        app.getIncydent().OznaczjakoPowaznyIncydent();
        app.getAkcja().Rozwiaz();
        app.getIncydent().RozwiazanieTemat();
        app.screenShot();
        app.saveandcloseButton();
        app.getAkcja().Zamknij();
        app.getIncydent().ZamkniecieIncydentuTemat();
        app.screenShot();
        app.saveandcloseButton();
        app.screenShot();
        app.logOut();
