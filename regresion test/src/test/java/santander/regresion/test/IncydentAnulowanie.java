...
public class IncydentAnulowanie extends TestBase {
    @Test

    public void testIncydentAnulowanie() throws Exception{
        ...
        app.saveandcloseButton();
        app.screenShot();
        app.getIncydent().AnulujIncydent();
        app.screenShot();
        app.getIncydent().AnulujIncydentKategoria();
        app.screenShot();
        app.saveandcloseButton();
        app.screenShot();
    }
